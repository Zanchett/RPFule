...
import { fighterFeats } from './feats-fighter'
import { rogueFeats } from './feats-rogue'
import { clericFeats } from './feats-cleric'
import { wizardFeats } from './feats-wizard'
import { bardFeats } from './feats-bard'
import { druidFeats } from './feats-druid'
import { rangerFeats } from './feats-ranger'
import { witchFeats } from './feats-witch'
import { generalFeats } from './feats-general'
import { ancestryFeats } from './feats-ancestries'
import { skillFeats as skillFeatsData } from './feats-skill'

export const feats: Feat[] = [
  // ========================
  // Ancestry Feats (all ancestries, levels 1-17)
  // ========================
  ...ancestryFeats,

  // ========================
  // Class Feats (all classes, levels 1-20)
  // ========================
  ...fighterFeats,
  ...rogueFeats,
  ...clericFeats,
  ...
  // ========================
  // Skill Feats (all skills, levels 1-15)
  // ========================
  ...skillFeatsData,
]
